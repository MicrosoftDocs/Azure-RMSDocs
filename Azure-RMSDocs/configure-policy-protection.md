...
When the label applies protection, a protected document is not suitable to be saved on SharePoint or OneDrive. These locations do not support the following features for protected files: Co-authoring, Office on the web, search, document preview, thumbnail, eDiscovery, and data loss prevention (DLP). 
