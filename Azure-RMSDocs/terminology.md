...
|Microsoft Information Protection| Sometimes abbreviated to *MIP*.<br /><br /> A framework for products and integrated capabilities that use the same labeling store and help you protect your organization's sensitive information.|
...
|unified label| Also known as a *unified sensitivity label*.<br /><br /> A label that can be applied by apps, clients, and services that support the Microsoft Information Protection framework, to apply classification and optionally, protection. In Office apps and services, unified labels are implemented as sensitivity labels.|
