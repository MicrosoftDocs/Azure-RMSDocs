...
Before you edit your templates or convert them to labels in the Azure portal, make sure that you are aware of the implementation changes, by reading [Considerations for templates in the Azure portal](configure-policy-templates.mdconsiderations-for-templates-in-the-azure-portal).
