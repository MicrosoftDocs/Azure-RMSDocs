...
2. If this is the first time that you have accessed the Azure Information Protection blade and Azure Rights Management is not activated for your tenant, you are prompted to activate Azure RMS from a quick start page. 
    
    If you do not see this option, from the initial Azure Information Protection blade, select **RMS Settings (Preview)**.  
