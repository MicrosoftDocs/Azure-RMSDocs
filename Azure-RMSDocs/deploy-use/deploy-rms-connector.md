...
> [!TIP]
> For a high-level example scenario with screenshots, see the [Automatically protecting files on file servers running Windows Server and File Classification Infrastructure](../understand-explore/what-do-admins-users-see.md#automatically-protecting-files-on-file-servers-running-windows-server-and-file-classification-infrastructure) section in the [Azure RMS in action](../understand-explore/what-do-admins-users-see.md) article.
...
-   **Step 4:**  [Configuring load balancing and high availability](install-and-configure-the-rms-connector.md#configuring-load-balancing-and-high-availability)

-   Optional: [Configuring the RMS connector to use HTTPS](install-and-configure-the-rms-connector.md#configuring-the-rms-connector-to-use-https)

-   Optional: [Configuring the RMS connector for a web proxy server](install-and-configure-the-rms-connector.md#configuring-the-rms-connector-for-a-web-proxy-server)
...
Go to [Installing and configuring the Azure Rights Management connector](install-and-configure-the-rms-connector.md).