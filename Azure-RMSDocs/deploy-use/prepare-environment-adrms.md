...
2. If you are not using an SCP, Windows computers that connect to an AD RMS cluster will be configured for [client-side service discovery](../rms-client/client-deployment-notes.md#rms-service-discovery) by using the Windows registry: `HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\MSIPC\ServiceLocation` 
