...
2. If you are not using an SCP, Windows computers that connect to an AD RMS cluster must be configured for client-side service discovery by using the Windows registry key: `HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\MSIPC\ServiceLocation`
