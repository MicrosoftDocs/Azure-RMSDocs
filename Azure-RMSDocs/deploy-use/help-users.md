...
> [!TIP]
> For a high-level example scenario with screenshots, see see [Users safely share attachments with mobile users](../understand-explore/what-admins-users-see.md#users-safely-share-attachments-with-mobile-users).
