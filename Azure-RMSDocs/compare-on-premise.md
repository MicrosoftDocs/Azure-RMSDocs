...
|Minimum supported version of Microsoft Office is Office 2010, which requires the [Azure Information Protection client](./rms-client/aip-client.md) or the RMS sharing application.<br /><br />Microsoft Office for Mac:<br /><br />- Office 365 ProPlus<br /><br />- Office for Mac 2016 and later: Supported|Minimum supported version of Microsoft Office is Office 2010.<br /><br />Microsoft Office for Mac:<br /><br />- Microsoft Office for Mac 2016 and later: Supported|
