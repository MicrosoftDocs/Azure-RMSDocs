...
|Supports the Azure Information Protection client (classic) and the Azure Information Protection unified labeling client.|Supports the Azure Information Protection client (classic) and consumption support only for the Azure Information Protection unified labeling client when you also install the [Active Directory Rights Management Services Mobile Device Extension](/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/dn673574\(v=ws.11\))
