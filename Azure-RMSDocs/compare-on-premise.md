...
|Minimum supported version of Microsoft Office is Office 2010, which requires the [Azure Information Protection client](./rms-client/aip-client.md).|Minimum supported version of Microsoft Office is Office 2010.|
