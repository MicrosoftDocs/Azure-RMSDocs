...
- **Classification and labeling**: Azure Information Protection supports these features with the [Azure Information Protection client (classic) and the Azure Information Protection unified labeling client](./rms-client.md/use-client#choose-which-azure-information-protection-client-to-use). These clients integrate with Office applications and File Explorer, whereas AD RMS does not. 
...
|Provides default protection templates that restrict access of the content to your own organization.<br /><br />You can also create your own custom templates, which include departmental templates that are visible to only a subset of users. For more information, see [Configuring and managing templates for Azure Information Protection](configure-policy-templates.md).<br /><br />In addition, users can define their own set of permissions if the templates are not sufficient.|There are no default templates; you must create and then distribute your own templates. For more information, see [AD RMS Policy Template Considerations](https://go.microsoft.com/fwlink/?LinkId=154765).<br /><br />In addition, users can define their own set of permissions if the templates are not sufficient.|
|Minimum supported version of Microsoft Office is Office 2010, which requires the Azure Information Protection client (classic) or Azure Information Protection unified labeling client.|Minimum supported version of Microsoft Office is Office 2010.|
|On Windows, supports the Azure Information Protection client (classic) and the Azure Information Protection unified labeling client. On iOS and Android, supports a viewer for protected files that can't be opened in Office apps. Mac computers continue to be supported by the RMS sharing app.|On Windows, supports the Azure Information Protection client (classic) and consumption support only for the Azure Information Protection unified labeling client for Windows when you also install the mobile device extension for AD RMS. On iOS and Android, supports a viewer for protected files that can't be opened in Office apps. Mac computers continue to be supported by the RMS sharing app.|
|Most [file types](./rms-client/client-admin-guide-file-types.md) can be classified and protected when you use the Azure Information Protection clients.<br /><br />For other applications, check the table in [Applications that support Azure Rights Management data protection](./requirements-applications.md).|Most [file types](./rms-client/client-admin-guide-file-types.md) can be protected when you use the Azure Information Protection client (classic) .<br /><br />For other applications, check the table in [Applications that support Azure Rights Management data protection](./requirements-applications.md).|
