...
- Maximum string lengths:
    ...
    - The maximum string length that you can enter for headers and footers is 1024 characters. However, Excel has a total limit of 255 characters for headers and footers. When you enter a long string for headers and footers, in Excel, the text can be truncated to 255 characters or less.
