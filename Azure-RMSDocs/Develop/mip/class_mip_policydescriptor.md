...
public void SetName | Sets policy name.
public const std::string & GetDescription | Gets policy description.
public void SetDescription | Sets policy description.
public const std::vector< UserRights > & GetUserRightsList | Gets collection of users-to-rights mappings.
...
public void SetContentValidUntil | Sets policy expiration time.
public bool DoesAllowOfflineAccess | Gets whether or not policy allows offline content access.
public void SetAllowOfflineAccess | Sets whether or not policy allows offline content access.
public const std::string & GetReferrer | Gets policy referrer address.
public void SetReferrer | Sets policy referrer address.
public const AppDataHashMap & GetEncryptedAppData | Gets app-specific data that was encrypted.
public void SetEncryptedAppDataAppDataHashMap & value) | Sets app-specific data that should be encrypted.
public const AppDataHashMap & GetSignedAppData | Gets the app-specific data that was signed.
public void SetSignedAppDataAppDataHashMap & value) | Sets app-specific data that should be signed.
## Members
### GetName
Gets policy name.
#### Returns
