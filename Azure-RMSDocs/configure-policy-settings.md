...
> 
> If you are looking for information to configure policy settings for the unified labeling client, see the Office documentation. For example, [Learn about sensitivity labels](https://docs.microsoft.com/microsoft-365/compliance/sensitivity-labels).
