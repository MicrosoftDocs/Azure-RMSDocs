...
| **Online mode in Outlook** | When working in [*Online* mode](/outlook/troubleshoot/installation/cached-exchange-mode) in Outlook, with the Azure Information Protection add-in active, new emails that are created and closed without edits are saved as drafts. In such cases, the user may see a pop-up message prompting them to save changes, and this message can be ignored.|
...
>
For more information about co-authoring support, see the [Microsoft 365 documentation](/microsoft-365/compliance/sensitivity-labels-coauthoring).
