...
- Replace *domain\user* with the domain name and user account name of the service account or user account
- Replace *DBName* with the name of the configuration database you're using for the scanner.
