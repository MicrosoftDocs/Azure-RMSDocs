...
|Azure Information Protection unified labeling client|Automatically refreshed every 4 hours, per Office app.<br /><br /> Additionally, because the Azure Information Protection client is tightly integrated with Office, any refreshed templates for Office 2016 will also be refreshed for the Azure Information Protection client.|
