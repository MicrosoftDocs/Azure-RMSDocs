...
## Estimating disk space and controlling data retention 
...
- For audit data generated by Azure Information Protection clients only: 2 GB per 10,000 active users.

- For audit data generated by Azure Information Protection clients, scanners, and Microsoft Defender ATP: 20 GB per 10,000 active users.

Use **Azure Monitor Logs** > **Log Analytics Usage and Estimated Costs** to help you review the data collected, and use **Data volume management** to control the data retention period for your workspace. For more information, see [Manage usage and costs with Azure Monitor Logs](https://docs.microsoft.com/azure/azure-monitor/platform/manage-cost-storage).
