...
Use **Azure Monitor Logs** > **Log Analytics Usage and Estimated Costs** to help you review the data collected, and after you have created your Log Analytics workspace, you can control the data retention period for it. For more information, see [Manage usage and costs with Azure Monitor Logs](https://docs.microsoft.com/azure/azure-monitor/platform/manage-cost-storage).
