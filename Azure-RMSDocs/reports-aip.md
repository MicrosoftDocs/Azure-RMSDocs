...
- **Data discovery (Preview)**: Use this report to see information about labeled files found by scanners and supported endpoints.
    ...
    Note: Discovery for endpoint is gradually rolling to tenants. You start to see data from the supported endpoints in this report when this feature is rolled out to your tenant.
