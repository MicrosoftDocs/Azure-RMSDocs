...
You can prevent the Azure Information Protection client writing its logging information by configuring an [advanced client setting](client-admin-guide-customizations.md#change-the-local-logging-level).
