...
|**Permissions to the data repositories**     |- **File shares or local files**: Grant **Read**, **Write**, and **Modify** permissions for scanning the files and then applying classification and protection as configured.  <br /><br />- **SharePoint**: You must grant **Full Control** permissions for scanning the files and applying classification and protection as configured through the sensitivity label policy.  <br /><br />- **Discovery mode**: To run the scanner in discovery mode only, **Read** permission is sufficient.         |
