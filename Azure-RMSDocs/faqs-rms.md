...
> [!NOTE]
> When you use Office for Mac and a minimum version of 16.55: Word, Excel, and PowerPoint (but not Outlook) now support the Rights Management usage right to prevent screen captures.
