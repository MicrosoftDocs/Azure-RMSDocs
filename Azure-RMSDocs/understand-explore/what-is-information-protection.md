...
For example, users need to send sensitive information in an email to personal email accounts that uses **Gmail**, **Hotmail**, or a **Microsoft** account. These emails should be encrypted at rest and in transit, and be read only by the original recipients.
