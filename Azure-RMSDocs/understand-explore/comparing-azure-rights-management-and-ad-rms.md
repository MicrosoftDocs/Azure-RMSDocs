...
|All file types can be protected with [native or generic protection when you use the RMS sharing application](../rms-client/rights-management-sharing-application-administrator-guide-technical-overview.md#levels-of-protection-native-and-generic).<br /><br />For other applications, check the [client devices capabilities table](https://technet.microsoft.com/library/dn655136.aspx#BKMK_ClientCapabilities).|All file types can be protected with [native or generic protection when you use the RMS sharing application](../rms-client/rights-management-sharing-application-administrator-guide-technical-overview.md#levels-of-protection-native-and-generic).<br /><br />For other applications, check the [client devices capabilities table](../get-started/rms-requirements-client-devices.md#client-device-capabilities).|
