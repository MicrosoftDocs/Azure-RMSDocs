...
|Supports migration from AD RMS and if required, to AD RMS:<br /><br />[Migrating from AD RMS to Azure Rights Management](../plan-design/migrate-from-ad-rms-to-azure-rms.md)<br /><br />[Decommissioning and deactivating Azure Rights Management](../deploy-use/decommissioning-and-deactivate-service.md)|Supports migration from Azure RMS and to Azure RMS:<br /><br />[Decommissioning and deactivating Azure Rights Management](../deploy-use/decommissioning-and-deactivate-service.md)<br /><br />[Migrating from AD RMS to Azure Rights Management](../plan-design/migrate-from-ad-rms-to-azure-rms.md)|
