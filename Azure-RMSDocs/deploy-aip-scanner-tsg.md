...
|**Other errors**     |  - [Error occurred while sending the request](#error-occurred-while-sending-the-request) <br>- [Missing content scan job or profile](#missing-content-scan-job-or-profile) <br>- [Scanner diagnostics errors](#scanner-diagnostics-errors)       |
|     |         |
