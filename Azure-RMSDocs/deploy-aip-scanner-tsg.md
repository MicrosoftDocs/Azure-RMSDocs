...
|**DB / Schema errors**     |  - [Database errors](#databese-errors) <br> - [Mismatched or outdated schema](#mismatched-or-outdated-schema)  |
|**Other errors**     |  -[Stuck scanner processes](#stuck-scanner-processes) <br>- [Unable to connect to remote server](#unable-to-connect-to-remote-server) <br>- [Error occurred while sending the request](#error-occurred-while-sending-the-request) <br>- [Missing content scan job or profile](#missing-content-scan-job-or-profile) <br>- [No repositories configured](#no-repositories-configured) <br>- [No cluster found](#no-cluster-found)   |
|     |         |
...
- In the Azure portal, on the **Nodes** page: `DLP policy is missing`
