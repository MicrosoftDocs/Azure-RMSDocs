...
|---------|---------|
|**Authentication errors**     |  - [Authentication token not accepted](#authentication-token-not-accepted) <br>  - [Authentication token missing](#authentication-token-mising)|
|**Policy errors**     | - [DLP policy missing](#dlp-policy-missing) <br> - [Policy doesn't include any automatic labeling condition](#policy-doesnt-include-any-automatic-labeling-condition)      |
|**Schema errors**     |   - [Mismatched or outdated schema](#mismatched-or-outdated-schema)  |
...
The DLP policy either failed to download or is missing entirely.
