...
If you have highly sensitive content that requires additional, on-premises protection, we recommend using [Double Key Encryption (DKE)](#double-key-encryption-dke-aip-unified-labeling-client-only).

> [!TIP]
> If you are using the classic client, and need additional, on-premises protection, use [Hold Your Own Key (HYOK)](#hold-your-own-key-hyok-aip-classic-client-only) instead.
>
