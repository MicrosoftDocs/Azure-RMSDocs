...
- **Technical support**. For example, a feature isn’t working and you have checked any requirements and followed the documentation instructions. Or, you have a question about licensing. Instead, use your standard support channels or [contact Microsoft Support](./get-started/information-support.md#to-contact-microsoft-support).
