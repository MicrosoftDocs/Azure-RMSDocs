...
For more information, see [How does Azure RMS work? Under the hood](how-does-it-work.md) to understand how a secret cola formula that is created and stored on-premises is protected by Azure RMS but remains on-premises.
