...
2. The Azure Information Protection blade is added to the Azure portal, the protection service is activated, and you have one or more labels published in your global policy.
...
4. For **Select the default label**, select one of the labels, such as **General**. 
    ...
    The **General** label is one of the default labels that Azure Information Protection can create for you. This step is covered in the [Create and publish labels](quickstart-viewpolicy.md#create-and-publish-labels) quickstart.
