...
4. For **Select the default label**, select one of the labels, such as **General**. 
    ...
    The **General** label is one of the default labels that Azure Inforamtion Protection can create for you and covered in the [Create labels - if necessary](quickstart-viewpolicy,nd#create-labels---if-necessary) quickstart.
