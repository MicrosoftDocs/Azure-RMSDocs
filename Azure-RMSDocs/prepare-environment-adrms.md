...
> [!TIP]
> You can also use the Windows PowerShell cmdlet, [Disable-AipService](/powershell/module/aipservice/disable-aadrm), to deactivate the Azure Rights Management service.
