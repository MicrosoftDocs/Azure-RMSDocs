...
|---------------|--------------------|
|A cloud subscription that includes Azure RMS|Your organization must have a cloud subscription that supports Rights Management.<br /><br />For more information, see [Cloud subscriptions that support Azure RMS](../get-started/requirements-subscriptions.md).|
