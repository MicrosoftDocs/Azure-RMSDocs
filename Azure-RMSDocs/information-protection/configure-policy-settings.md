...
3. On the **Azure Information Protection** blade, configure these global settings:
    ...
    **Select the default label**: When you set this option, select the label to assign to documents and emails that do not have a label. 

    You cannot set a label as the default if it has sub-labels. 
