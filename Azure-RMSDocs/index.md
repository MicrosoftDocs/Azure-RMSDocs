        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Learn more about Azure Information Protection</h3>
                    </div>
                </div>
            </div>
        </div>
...
<ul class="panelContent cardsW">
    ...
                <div class="card">
                    <div class="cardText">
                        <p><a href="/enterprise-mobility-security/solutions/infoprotect-secure-classify-scenario">Developer's guide</a></p>
                    </div>
                </div>
            </div>
        </div>
