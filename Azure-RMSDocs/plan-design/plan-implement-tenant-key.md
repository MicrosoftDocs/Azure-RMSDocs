...
If you need to confirm that the key URL is set correctly in the Azure RMS service, in Azure Key Vault, you can run [Get-AzureKeyVaultKey](https://msdn.microsoft.com/library/dn868053.aspx) to see the key URL.
