...
description: Phase 5 of migrating from AD RMS to Azure Information Protection, covering steps x through x from Migrating from AD RMS to Azure Information Protection.
author: cabailey
ms.author: cabailey
manager: mbaldwin
ms.date: 03/08/2017
