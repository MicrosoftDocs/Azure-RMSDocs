...
description: Phase 1 of migrating from AD RMS to Azure Rights Management (Azure RMS), covering steps 1 though 4 from Migrating from AD RMS to Azure Rights Management.
author: cabailey
manager: mbaldwin
ms.date: 08/25/2016
ms.topic: article
