...
title: Migrating from AD RMS to Azure Information Protection - Phase 1 | Azure Information Protection
...
- If you created Azure RMS custom templates before the migration, you must manually export and import them.
