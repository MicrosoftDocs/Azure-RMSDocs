...
Use the following information for Phase 1 of migrating from AD RMS to Azure Information Protection. These procedures cover steps x though x from [Migrating from AD RMS to Azure Information Protection](migrate-from-ad-rms-to-azure-rms.md).
