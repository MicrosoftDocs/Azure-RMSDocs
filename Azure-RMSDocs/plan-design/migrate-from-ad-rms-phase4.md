...
description: Phase 4 of migrating from AD RMS to Azure Rights Management (Azure RMS), covering steps 8 through 9 from Migrating from AD RMS to Azure Rights Management.
author: cabailey
manager: mbaldwin
ms.date: 08/17/2016
ms.topic: article
