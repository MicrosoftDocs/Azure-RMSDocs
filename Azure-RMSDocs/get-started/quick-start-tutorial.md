...
description: An introduction tutorial to quickly try out Microsoft Azure Rights Management for your organization with just 5 steps that should take you less than 15 minutes.
keywords:
author: cabailey
manager: mbaldwin
ms.date: 08/24/2016
...
![Azure RMS quick start tutorial all steps](../media/AzRMS_QuickStartStepsAll.PNG)
