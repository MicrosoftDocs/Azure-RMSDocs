...
|**Windows 10 Mobile**|Office Mobile apps (viewing protected documenting using Azure RMS) <br /><br />Web browser [[2]](#footnote-2)|Not supported|Citrix WorxMail <br /><br />Outlook Mail <br /><br />Web browser [[3]](#footnote-3)|Not supported|
...
|**Windows Phone 8.1**|Office Mobile (AD RMS only)<br /><br />Web browser [[2]](#footnote-2)|RMS sharing app (viewing protected documents)|Outlook Mobile [[4]](#footnote-4) <br /><br />Web browser [[3]](#footnote-3)|RMS sharing app (viewing protected text, images, generically protected files)|
|**Blackberry 10**|Web browser [[2]](#footnote-2)|Not supported|Blackberry email [[4]](#footnote-4) <br /><br />Web browser [[3]](#footnote-3)|Not supported|
...
###### Footnote 2
For [Office attachments](https://support.office.com/article/Introduction-to-IRM-for-email-messages-bb643d33-4a3f-4ac7-9770-fd50d95f58dc) that are protected by using Office 365 Message Encryption with new capabilities as described in the following Office documentation: [Setting up the new Office 365 Message Encryption capabilities built on top of Azure Information Protection](https://support.office.com/article/7ff0c040-b25c-4378-9904-b1b50210d00e).
