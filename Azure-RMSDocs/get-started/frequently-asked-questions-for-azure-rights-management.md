...
Yes. See [Exchange Online: IRM Configuration](../deploy-use/0365-configure-for-clients-online-services#exchange-online-irm-configuration.md ) to see a typical set of commands that enables Exchange Online to use Azure RMS, why the Outlook Web App doesn't immediately show the **Set permissions** menu options, and the command to run if you change or update the Azure RMS templates. 
...
For more information about custom templates, see [Configuring custom templates for Azure Rights Management](../deploy-use/configuring-custom-templates-for-azure-rights-management.md).
