...
### [Step 1: Configure and publish policy](infoprotect-tutorial-step1.md)
### [Step 2: Install the client](infoprotect-tutorial-step2.md)
### [Step 3: See it in action - labeling, classification, protection](infoprotect-tutorial-step3.md)
### [Step 4: See it in action - share protected and tracking](infoprotect-tutorial-step4.md)
