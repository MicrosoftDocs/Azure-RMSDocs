...
|---------------|--------------------|
|A cloud subscription for Azure Information Protection|For licensing information, see the Azure Information Protection marketing site. <br /><br />Note that some Azure Information Protection features are available only for specific subscriptions. |
