...
- Label names and tooltips are supported in one language only. However, multi-language support is now in private preview. For more information and to apply for this private preview, see the blog post [Azure Information Protection unified administration phase two](https://blogs.technet.microsoft.com/enterprisemobility/2017/05/23/azure-information-protection-unified-administration-phase-two/).
