...
If you are using Windows Update, the Azure Information Protection client automatically upgrades the client, irrespective of how the client was installed. New releases become available for download in the catalog a few weeks after the release.

Alternatively, you can manually upgrade the client by downloading the new release from the [Microsoft Download Center](https://www.microsoft.com/en-us/download/details.aspx?id=53018). Install the new version to upgrade the client. 
