...
After you have installed the Azure Information Protection client, make sure that you provide users with instructions how to label their documents and emails, and guidance for which labels to choose for specific scenarios. For example:
