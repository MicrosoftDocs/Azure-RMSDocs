...
The this section lists the features supported by the classic client, in parallel with the comparison section for the unified labeling client and built-in labeling solution in [Learn about about built-in labeling and the AIP unified labeling client](use-client.md).
