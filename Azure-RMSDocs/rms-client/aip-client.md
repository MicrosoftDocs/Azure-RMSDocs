...
### Detailed comparisons for features in Office apps
...
**Consumption**: <br /> - ISO standard for PDF encryption <br />- .ppdf<br />- SharePoint IRM protection| **Protection**: <br /> - ISO standard for PDF encryption <br /> <br /> **Consumption**: <br /> - ISO standard for PDF encryption <br />- .ppdf<br />- SharePoint IRM protection|
...
### Detailed comparisons for features outside of Office apps

|Functionality |Classic client|Unified labeling client|
|--------------|-----------------------------------|-----------------------------------------------------------|
|**Supported formats for PDF**| **Protection**: <br /> - ISO standard for PDF encryption (default) <br /> - .ppdf
