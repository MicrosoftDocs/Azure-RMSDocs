...
|Protect a file that you share by email <br /><br />Also known as "share protected"|Apply a label with the required protection to your document or email message, or select the Outlook **Do Not Forward** option.<br /><br />For more information, see [Classify and protect a file or email](client-classify-protect.md).
