...
Usage logging is supported with the Azure Information Protection unified labeling client [version 2.12.62](unifiedlabelingclient-version-release-history#version-212620) and higher.
