...
Built-in labeling supports selected PowerShell advanced settings with [New-Label](/powershell/module/exchange/new-label) and [Set-Label](/powershell/module/exchange/set-label), [New-LabelPolicy](/powershell/module/exchange/new-labelpolicy) and [Set-LabelPolicy](/powershell/module/exchange/new-labelpolicy). However, many customizations are now supported by the wizards in the Microsoft 365 compliance center. For more information, see [Manage sensitivity labels in Office apps](/microsoft-365/compliance/sensitivity-labels-office-apps).
