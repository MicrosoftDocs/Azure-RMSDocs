...
|A viewer for protected files:| Yes | Yes |
...
|Opening generically protected files (.pfile) with the viewer:| File opens in the original app where it can then be viewed, modified, and saved without protection | File opens in the original app where it can then be viewed and modified, but not saved|
