...
|Customizable tooltips for automatic and recommended labels: Yes <br /><br />Use the Azure portal to replace the default text | No <br /><br /> Although the admin centers have an option to supply a customized policy tip, this option is not currently supported by the unified labeling client|
