...
- New advanced client settings that implement pop-up messages in Outlook that warn, justify, or block emails being sent. [More information](#implement-pop-up-messages-in-outlook-that-warn-justify-or-block-users-sending-emails)
