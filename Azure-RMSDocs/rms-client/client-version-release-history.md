...
- You can now configure a label for user defined permissions for Word, Excel, PowerPoint, and File Explorer and also use the advanced client setting to hide the custom permissions options. [More information](client-admin-guide-customization.md#make-the-custom-permissions-options-unavailable-to-users) 
