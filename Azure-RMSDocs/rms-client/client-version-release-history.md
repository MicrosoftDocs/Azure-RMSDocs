...
- A new advanced client setting, as an alternative to editing the registry to [prevent sign-in prompts for AD RMS only computers](client-admin-guide-customizations.md#prevent-sign-in-prompts-for-ad-rms-only-computers).
