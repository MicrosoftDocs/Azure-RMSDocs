...
As we continue to bring the customer labeling and protection experience to built-in applications like Office 365, the **Azure Information Protection add-in** has moved into **maintenance mode** as of **January 1, 2022**. As listed in the [Technical overview of the Azure Information Protection unified labeling client](clientv2-admin-guide#technical-overview-of-the-azure-information-protection-unified-labeling-client), there are multiple components that make up the Azure Information Protection unified labeling client and other components are still supported. For more information, see our [TechCommunity blog](https://techcommunity.microsoft.com/t5/security-compliance-and-identity/azure-information-protection-and-the-information-protection/ba-p/3671070#:~:text=Azure%20Information%20Protection%20%28AIP%29%20has%20been%20on%20a,management%20experience%20into%20the%20Microsoft%20Purview%20compliance%20portal.).
