...
title: View protected files by using the Azure Information Protection unified labeling client for Windows
description: Instructions to view a protected file that requires you to have the Azure Information Protection unified labeling client installed.
author: cabailey
ms.author: cabailey
manager: barbkess
ms.date: 04/17/2019
...
# User Guide: View files that have been protected by Rights Management
