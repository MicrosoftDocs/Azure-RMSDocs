...
title: Remove sensitivity labels by using the Azure Information Protection unified labeling client for Windows
description: Instructions to remove sensitivity labels and protection from files that have been labeled by Azure Information Protection.
author: cabailey
ms.author: cabailey
manager: barbkess
ms.date: 04/17/2019
