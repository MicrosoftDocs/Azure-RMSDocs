...
- **To remove protection from files for others using your own account**:
    ...
    To remove protection from files, you must be a super user or have a Rights Management usage right. The suer user feature is typically used for data discovery or recovery.
