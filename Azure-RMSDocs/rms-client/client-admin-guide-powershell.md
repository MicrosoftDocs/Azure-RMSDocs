...
Examples for using these AIP cmdlets:
...
- [Using PowerShell for the Azure Information Protection service and Azure Rights Management service](client-admin-guide-powershell-aip-azurerms.md)
...
- [Using PowerShell for the Azure Information Protection client and Active Directory Rights Management Services](client-admin-guide-powershell-adrms.md)
