...
2. In the **Microsoft Azure Information Protection** dialog box, specify the following:
    ...
    If you have the current preview version of the Azure Information Protection client, you can also select the **Select users, groups, or organization** button. This button displays the **Select Users or Groups** dialog box for your on-premises Active Directory. To use this button, your computer must be connected to the internal network, your computer must be joined to the domain, and the users and groups to select must be in your on-premises Active Directory. If any of these conditions are not met, you see the following message: **The program cannot open the required dialog box because no locations can be found.**
...
4. If you selected the custom permissions option, now specify the following:
    ...
    You can also use the **Select users, groups, or organization** button to select users or groups from the Outlook address book. If you have the current preview version of the Azure Information Protection client, this button displays the **Select Users or Groups** dialog box for your on-premises Active Directory. To use this button, your computer must be connected to the internal network, your computer must be joined to the domain, and the users and groups to select must be in your on-premises Active Directory. If any of these conditions are not met, you see the following message: **The program cannot open the required dialog box because no locations can be found.**
