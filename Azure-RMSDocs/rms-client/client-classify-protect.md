...
2. In the **Microsoft Azure Information Protection** dialog box, specify the following:
    ...
    You can also use the **Select users, groups, or organization** button to select users or groups from the Outlook address book. If you have the current preview version of the Azure Information Protection client, this button displays the **Select Users or Groups** from your on-premises Active Directory.
...
4. If you selected the custom permissions option, now specify the following:
    ...
    If you have the current preview version of the Azure Information Protection client, you can also select the **Select users, groups, or organization** button. This button displays the **Select Users or Groups** from your on-premises Active Directory.
