...
2. In the **Microsoft Azure Information Protection** dialog box, specify the following:
    ...
    Note that if this setting was previously configured by using custom permissions from an Office 2010 app, the specified expiry date does not display in this dialog box but it is still set. This is a display issue only when it was configured in Office 2010.
