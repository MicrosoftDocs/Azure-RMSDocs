...
- [How-to: deploy an app](how-to-deploy-app.md) - outlines the steps for migrating an app from its developement Azure AD tenant to a deployment Azure AD tenant.
