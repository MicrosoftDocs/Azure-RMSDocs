...
> [!Note]
> If you receive an error accessing Microsoft Connect, you have likely not registered. To register: go to [Connect](www.connect.microsoft.com), sign in with your Microsoft Account > Directory > Search for Rights Management Services > Join.
