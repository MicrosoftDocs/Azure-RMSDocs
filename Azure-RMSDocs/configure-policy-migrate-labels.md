...
- If you're not ready for the migrated labels in the copied policies to be published, you can remove the labels from the label policies in your admin labeling center. 
