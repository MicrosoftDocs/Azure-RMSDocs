...
|Any authenticated user protection setting |Yes|No configuration option to support this protection setting. We do not recommend you publish a label with this configuration.|
