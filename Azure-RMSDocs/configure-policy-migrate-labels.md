...
|Visual markings (header, footer, watermark): Custom font and custom font color by RGB code|No|Recommended if you use variables<br /><br />Notes: Variables will display as text rather than the dynamic values|
