...
- Protection templates:
    ...
    - If you have labels that are configured for a predefined template, [convert these to labels](configure-policy-templates.md#to-convert-templates-to-labels) before you migrate your labels. This configuration will not block label migration but is not supported in the Security & Compliance Center.
