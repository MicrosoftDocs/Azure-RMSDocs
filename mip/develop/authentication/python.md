...
- [Python Authentication Example](#python-authentication-example)
  - [Summary](#summary)
  ...
  - [Update AcquireOAuth2Token](#update-acquireoauth2token)
  - [Next Steps](#next-steps)

## Summary

This Python authentication example expands upon the [simple authentication sample]() by demonstrating calling an external Python script to obtain the OAuth2 token.
