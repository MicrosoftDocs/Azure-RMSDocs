---
title: File types supported - Microsoft Information Protection (MIP) SDK
...
The following file types can be labeled even when they are not protected.
...
For example, if a label **General** does not apply protection, you could apply the **General** label to a file named sales.pdf but you could not apply this label to a file named sales.txt.
