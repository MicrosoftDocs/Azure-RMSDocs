...
Complete the coding portion of this Quickstart, by adding code that instantiates the profile and engine. You also update the code to use your Azure AD application ID, and the `AcquireOAuth2Token()` to use a static token for testing: 
...
3. Replace the following 2 `<AppId>` placeholders with the Application ID from the Azure AD app you registered in MIP SDK setup and configuration.
