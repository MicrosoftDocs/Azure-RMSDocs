...
description: A quickstart showing you how to write the initialization logic for a Microsoft Information Protection SDK client application using the File SDK.
author: msmbaldwin
