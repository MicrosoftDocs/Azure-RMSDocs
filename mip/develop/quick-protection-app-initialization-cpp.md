...
description: A quickstart showing you how to write the initialization logic for Microsoft Purview Information Protection SDK client applications using the Protection SDK (C++)
author: msmbaldwin
