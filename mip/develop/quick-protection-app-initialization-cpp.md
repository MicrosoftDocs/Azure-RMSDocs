...
description: A quickstart showing you how to write the initialization logic for Microsoft Information Protection SDK client applications using the Protection SDK (C++)
author: msmbaldwin
