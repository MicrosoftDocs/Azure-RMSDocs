...
An application can pass any type of context (for example, std::promise, std::function) to [ProtectionEngine::CreateDelegationLicensesAsync](undefined) and that same context will be forwarded as-is to [ProtectionEngine::Observer::OnCreateDelegatedLicensesSuccess](#classProtectionEngine_1_1Observer_1a0218cd29f63297d3178033b5225d9f6a) or [ProtectionEngine::Observer::OnCreateDelegatedLicensesFailure](#classProtectionEngine_1_1Observer_1a0a3ead878a44cdce11a3de078e8452dc)
