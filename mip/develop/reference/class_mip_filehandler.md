...
Throws [JustificationRequiredError](#classmip_1_1JustificationRequiredError) when setting the label requires the operation to be justified (via the labelingOptions parameter).
