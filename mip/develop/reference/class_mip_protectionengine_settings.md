...
Settings](undefined) used by [ProtectionEngine during its creation and throughout its lifetime.
...
Parameters:  
* **identity**: Identity](undefined) that will be associated with [ProtectionEngine
