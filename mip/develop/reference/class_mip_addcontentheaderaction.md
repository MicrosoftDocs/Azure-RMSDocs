...
**Returns**: The name that should be used for the UI element that holds the content header. The same name will be returned in [RemoveContentHeaderAction](#classmip_1_1RemoveContentHeaderAction) in case the content header needs to be removed.
