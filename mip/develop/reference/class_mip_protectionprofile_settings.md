...
Settings](undefined) used by [ProtectionProfile during its creation and throughout its lifetime.
...
* **observer**: Observer](undefined) instance that will receive notifications of events related to [ProtectionProfile
...
**Returns**: Observer](undefined) that receives notifications of events related to [ProtectionProfile
