...
**Returns**: The name that should be used for the UI element that holds the content footer. The same name will be returned in [RemoveContentFooterAction](#classmip_1_1RemoveContentFooterAction) in case the content footer needs to be removed.
