...
Authentication in the MIP SDK is performed by extending the class `mip::AuthDelegate` to implement your preferred method of authentication. The SDK has no internal authentication implementation. It's the responsibility of application developers to implement their preffered library for fetchin OAuth2 tokens.

`mip::AuthDelegate` contains:
