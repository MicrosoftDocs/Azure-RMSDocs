---
title: Quickstart - Initialization for Microsoft Information Protection SDK C# clients
description: A quickstart showing you how to write the initialization logic for a Microsoft Information Protection SDK C# client applications.
author: tommoser
...
- Complete the steps in [Microsoft Information Protection SDK setup and configuration](setup-configure-mip.md). This "Client application initialization" Quickstart relies on proper SDK setup and configuration.
- Optionally:
